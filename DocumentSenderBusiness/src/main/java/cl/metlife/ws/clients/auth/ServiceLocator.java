...
public class ServiceLocator extends org.apache.axis.client.Service implements cl.metlife.ws.clients.auth.Service {
    ...
    private java.lang.String ServiceSoap_address = "http://webdesacp01:302/WS_AUTENTIFICA.asmx";
    ...
    public cl.metlife.ws.clients.auth.ServiceSoap_PortType getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cl.metlife.ws.clients.auth.ServiceSoap_BindingStub _stub = new cl.metlife.ws.clients.auth.ServiceSoap_BindingStub(portAddress, this);
    ...
    private java.lang.String ServiceSoap12_address = "http://webdesacp01:302/WS_AUTENTIFICA.asmx";
    ...
    public cl.metlife.ws.clients.auth.ServiceSoap_PortType getServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cl.metlife.ws.clients.auth.ServiceSoap12Stub _stub = new cl.metlife.ws.clients.auth.ServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cl.metlife.ws.clients.auth.ServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                cl.metlife.ws.clients.auth.ServiceSoap_BindingStub _stub = new cl.metlife.ws.clients.auth.ServiceSoap_BindingStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
            if (cl.metlife.ws.clients.auth.ServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                cl.metlife.ws.clients.auth.ServiceSoap12Stub _stub = new cl.metlife.ws.clients.auth.ServiceSoap12Stub(new java.net.URL(ServiceSoap12_address), this);
                _stub.setPortName(getServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
